...
#' @param family distribution function for responses. Options are poisson(link = "log"), "negative.binomial" (with log link), binomial(link = "probit") , zero inflated poisson ("ZIP"), gaussian(link = "identity"), "gamma" (with log link), and "ordinal".
